...
from a first mate dispatching cross-project priority, or directly from the captain
...
- **Report a compact structured result upward.** When your assignment is
  ...
  captain's decision - a reference/summary a first mate or the captain can act on
...
- `captain` - the captain's own words, quoted.
...
### The intent is also the captain's to correct
