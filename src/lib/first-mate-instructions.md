...
A request to work a **single** project ("I want to work on beatdrop", "let's
look at the Crewline bug") is the same move at n=1, and it is your single most
...
captain at it: "the beatdrop second mate is set up - jump into it in the Fleet."
...
- **Don't become a standing relay.** Do not route routine, single-project
  work through yourself "just in case." If Aidin wants to work a project
...
The hierarchy is the default path, not a gate. Aidin can go straight to a
...
Any significant decision made directly between Aidin and a second mate (or
