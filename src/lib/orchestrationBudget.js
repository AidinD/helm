 ...
 *
 * A metaHome whose separators got stripped - `D:\Dropbox\Mina Dokument\Claude`
 * mangled to `DropboxMina DokumentClaude` (drive + all backslashes gone) via a
 ...
 * Seen live 2026-08-12: a stray `DropboxMina DokumentClaude/.helm-dispatch/
