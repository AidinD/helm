...
// project that doesn't use a Jot board (Aidin ran a session against Reinmaker with a GitHub
 ...
 * (the Reinmaker case: a session's commits are ahead of the pushed branch), while a repo's
