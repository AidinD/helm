...
// slow machine tagged the captain's perfectly clear card needs-clarification and told him
...
const HANDOFF_CATEGORY_PROMPT = [
  ...
  "- Reuse an existing topic when the note is about the SAME SUBJECT as that topic.",
  "- Sharing a word is NOT the same subject. Words like training, coaching, review, planning or",
  "  development mean different things in different parts of a life: professional leadership",
  "  development and physical exercise are DIFFERENT subjects even though both can be called",
  "  'training and coaching'. Judge the subject from the note's content, not from word overlap",
  "  with a topic name.",
