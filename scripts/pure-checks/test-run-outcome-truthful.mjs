...
//
// THE BUG THIS LOCKS DOWN, measured on the real skiff board 2026-08-18: 22 of 23
...
// Verbatim (stoppedReason, commitCount) pairs from the 23 skiff reports on disk,
...
ok(REAL.length === 23, `replaying all ${REAL.length} real skiff reports`);
