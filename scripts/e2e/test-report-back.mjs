...
try {
  ...
  // else surfaces landed-but-unread work, and 117 crew commits reached skiff's
  ...
  // Settled with the captain 2026-08-20: needs-you is an ALARM, so the one successful outcome
