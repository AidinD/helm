...
for (const [needle, why] of [
  ...
  ["not confirmed by Aidin", "a paraphrase is marked as one rather than presented as his stated ask"],
...
const commitHtml = buildCommitReviewHtml({
  commit: { sha: "0123456789abcdef", shortSha: "01234567", subject: "Bump deps", body: "Because of X.", author: "Aidin", date: "2026-08-11" },
  projectName: "helm",
  diffText,
});
...
ok(commitHtml.includes("Aidin") && commitHtml.includes("2026-08-11"), "with who wrote it and when");
