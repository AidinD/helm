...
ok(allows("Bash", { command: "cat D:/Dropbox/jot/todos.json" }), "cat, reading the board - the single most common thing this tier does");
...
ok(allows("mcp__helm-dispatch__helm_create_second_mate", { project: "beatdrop" }), "and the delegation tool this guard exists to push it toward");
...
// TALKING about a write. Aidin's own note from 2026-07-03 is that a compound command
