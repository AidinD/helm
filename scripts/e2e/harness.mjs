...
// down Reinmaker or the user's own Helm. A stray instance left running is a real
 ...
 * per-run E2E profile whose owning test run is gone. Aidin's own Helm runs out of
 ...
 * cannot reach Aidin's own Helm, whose profile is %APPDATA%\helm.
 */
