...
//
// Aidin ran `npm run dev` on a Vite project through the panel on 2026-08-02 and got
...
const vite = `${E}[2m14:11:14${E}[22m ${E}[36m${E}[1mvite${E}[22m${E}[39m ${E}[35m${E}[2m(beatdrop)${E}[22m${E}[39m Re-optimizing dependencies`;
...
ok(text(segs) === "14:11:14 vite (beatdrop) Re-optimizing dependencies", `the readable text is exactly what a terminal would show (${JSON.stringify(text(segs))})`);
...
ok(stripAnsi(vite) === "14:11:14 vite (beatdrop) Re-optimizing dependencies", "stripAnsi gives the same readable text with no styling");
