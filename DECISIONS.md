...
**Decision:** Before committing to the Maestro rebuild (the captain: "before we
...
Self-correcting and authoritative: as the captain runs each model through Maestro
...
Verified live: ran it while Halyard's 4 processes were up — Maestro
...
**Decision (the captain, settled in conversation):** Maestro's mental model is an
...
valuable: the persistent coordinator the captain actually wants (the "Maestro chat"
