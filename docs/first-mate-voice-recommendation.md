...
Not built. This is the "how would it fit / how would we push it in" write-up Aidin asked for.
...
The reason to be this conservative is Aidin's own standing rules: concise, no fluff, honest, push back, no em-dash.
...
Without that clause, a model will happily drift into "Arr, the Crewline deadline be lookin' grim, cap'n" - exactly the failure mode the task worries about.
