...
"prepare a concrete proposal so Aidin can decide the direction" deliverable.
...
## The mismatch (Aidin's insight, 2026-07-07)

Aidin would never fill this in by hand - he doesn't know, off the top of his
...
1. **Primary interface = intent.** The captain says *what* and *where* -
   "get the logo task done in beatdrop", or picks a Jot task - and nothing
